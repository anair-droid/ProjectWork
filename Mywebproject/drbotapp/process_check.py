...
def construct_dataframe(processes):
    ...
    df.sort_values('memory_usage', inplace=True, ascending=False)
    # pretty printing byte
    ...
    # df = df[columns.split(",")]
    # df = df['name', 'memory_usage', 'write_bytes','read_bytes','create_time']
    columns = {'name', 'create_time','cpu_usage', 'status', 'memory_usage'}
    df = df[columns]
    return df
